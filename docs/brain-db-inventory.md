...
| permagent | 86 |
| getladle | 56 |
| atlasatlantic-site | 49 |
| polybot | 24 |
| atlas-atlantic | 17 |
| atlas-atlantic-listener | 17 |
| love-nova-scotia | 8 |
| agent-lightning | 7 |
...
`conversation`, `core`, `daily`, `fact`, `love-ns`, `openbird`, `permagent`, `projects`, `task`

### Sample memories (anonymized)

| id (truncated) | wing | hall | signal | len | content excerpt |
|----------------|------|------|--------|-----|-----------------|
| fd8824aa... | henry-infra | event | 0.6 | 1,371 | Task [failed] via claude-code. Description: PHASE 2: RESTART BACKEND. Find the running uvicorn process... |
...
| f913f4bd... | jesse | advice | 0.85 | 5,830 | [REDACTED] can you submit this as a task to Claude Code via the task runner: Task: Wire [REDACTED] Waitlist to [REDACTED] + [REDACTED]. Context: The [REDACTED] site... |
| ea55bb6e... | henry-infra | event | 0.6 | 2,461 | Task [completed] via claude-code. Description: Fix agent positioning in [REDACTED].tsx in command-center-ui. Agents clustered instead of spread across the lab... |
...
|----|-----------------|------------------|------------------|------|-------------|-------------|-------------------|
| f2a16a72fcad48c5 | 4c355a4f544a52f5 | e04e761c-d4d7-... | 01e381ce-39a7-... | atlas-atlantic | fact | fact | same_day |
| c61771f3bd97495e | 4c355a4f544a52f5 | e04e761c-d4d7-... | 0bfb57a3-3358-... | atlas-atlantic | fact | fact | same_day |
| 52c7402480fd467a | 4c355a4f544a52f5 | e04e761c-d4d7-... | f857fb2f-557a-... | atlas-atlantic | fact | fact | same_day |
| 695406bce158446f | 4c355a4f544a52f5 | e04e761c-d4d7-... | 8017a8df-9d00-... | atlas-atlantic | fact | fact | same_day |
| dfcfcaaf1a934163 | 4c355a4f544a52f5 | e04e761c-d4d7-... | b15c927f-6c0a-... | atlas-atlantic | fact | fact | same_day |
