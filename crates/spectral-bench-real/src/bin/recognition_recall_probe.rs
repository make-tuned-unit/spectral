...
fn main() {
    ...
    for (i, c) in corpus.iter().enumerate() {
        brain
            .remember(&format!("m{i}"), c, Visibility::Private)
            .unwrap();
    ...
    let cases: &[(&str, &str, usize, &str)] = &[
        (
            "keyword-overlap ",
            "what is my shellfish allergy situation",
            0,
            "FTS-easy",
        ),
        (
        ...
        (
            "distinct-collocation",
            "shellfish reaction epipen",
            12,
            "rare-pair",
        ),
        (
            "distinct-collocation",
            "Q2 budget review March slot",
            15,
            "rare-pair",
        ),
        (
            "reorder/paraphrase",
            "teeth grinding at night wearing down enamel",
            14,
            "reorder",
        ),
        (
            "near-duplicate  ",
            "I am allergic to shellfish and get hives",
            0,
            "near-dup",
        ),
        (
            "entity-carryover",
            "how is Biscuit the beagle doing",
            16,
            "entity",
        ),
        (
            "entity-carryover",
            "Lincoln kindergarten drop-off",
            18,
            "entity",
        ),
        ...
        (
            "pure-synonym    ",
            "automobile stopping pads winter",
            13,
            "synonym",
        ),
        (
